...
<head>
    ...
    <title>Personaggi Mitologigi</title>
    {{-- Bootstrap --}}
        ...
        <div class="row justify-content-center align-items-center ">
            ...
            <div class="col-12 col-md-3 py-5">
                ...
                <div class="card  mx-auto d-flex  align-items-stretch" >
                    ...
                    <a href="{{ route('show.mostro', $mostro['id']) }}"><img src="{{$mostro['img']}}" class="card-img-top card-custom" style="height:350px; object-fit:cover;" alt="immagine {{$mostro['img']}}" ></a>            
